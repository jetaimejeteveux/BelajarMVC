...
public class ModelPraktikum {
    ...
    static final String DB_URL = "jdbc:mysql://localhost/belajarmvc?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";//nama database
    ...
    public int getBanyakData(){ //menghitung jumlah baris yg ada
        ...
        try{
            ...
            ResultSet resultSet = statement.executeQuery(query); //untuk pengambilan data dalam java dari database
            while(resultSet.next()){ //mengambil nilai dari baris ke 0 sampai baris akhir
                jmlData++;
            }
